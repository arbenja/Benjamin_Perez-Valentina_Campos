...
function displayBooks(items){
    ...
    searchFor.textContent=`Resultados para:'${search.value}'`;
    ...
    items.map((item)=>{
        ...
        author.innerHTML=`<strong>Autor/es:</strong> ${book.authors}`;
        let pageCount=document.createElement("p");
        pageCount.innerHTML=`<strong>Num páginas:</strong> ${book.pageCount}`;
        let publisher=document.createElement("p");
        publisher.innerHTML=`<strong>Editor:</strong> ${book.publisher}`;
